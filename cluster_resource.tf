...
//wait for cluster status to cahnge to active state
...
module "rancher_users" {
  source              = "./modules/rancher_users"
  rancher_usernames   = var.rancher_usernames
  rancher_password    = var.rancher_password
  user_global_role    = var.user_global_role
