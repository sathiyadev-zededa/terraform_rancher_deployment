...
module "zededa_users" {
  source              = "./modules/zededa_users"
  zededa_users        = var.zededa_users
  access_project      = var.access_project
  access_edgeapp      = var.access_edgeapp
  access_app_instance = var.access_app_instance
  access_user         = var.access_user
  access_enterprise   = var.access_enterprise
  access_device       = var.access_app_instance
